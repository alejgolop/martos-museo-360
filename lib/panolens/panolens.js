...
(function (global, factory) {
	...
	function Infospot2 ( scale = 300, imageSrc) {
	    imageSrc = imageSrc || DataImage.Info;
		this.geometry=new THREE.PlaneGeometry(100, 100);
		THREE.Mesh.call(this);
		this.type = 'infospot';
		this.lookAt(viewer.camera.position);
		this.frustumCulled=false;
	...
	Infospot2.prototype = Object.assign( Object.create( THREE.Mesh.prototype ), {
	    constructor: Infospot2,
	...
	Panorama.prototype = Object.assign( Object.create( THREE.Mesh.prototype ), {
	    ...
	    add: function ( object ) {
	        ...
	        if ( object instanceof Infospot || object instanceof Infospot2 ) {
